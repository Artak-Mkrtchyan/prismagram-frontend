...
export const Auth = () => {
  ...
  const [requestSecretMutation] =
    useMutation<{ requestSecret: () => {} }>(LOG_IN);
  const [createAccountMutation, { error, data: createAccountData }] =
    useMutation<CreateAccountMutationData, NewUserDetails>(CREATE_ACCOUNT, {
      variables: {
        email: email.value,
  ...
  const [confirmSecretMutation] =
    useMutation<{ confirmSecret: any }>(CONFIRM_SECRET);
